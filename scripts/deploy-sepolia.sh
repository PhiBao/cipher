#!/usr/bin/env bash
# Deploy CipherProtocol to Sepolia and regenerate the frontend's TS ABIs.
#
# Required env vars:
...
FORGE_ARGS=(
  script/DeployCipherProtocol.s.sol:DeployCipherProtocol
...
echo "    packages/nextjs/contracts/CipherProtocol.ts."
